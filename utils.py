...
# ===============================
# Patch: restore top_k_top_p_filtering
# ===============================
import torch
...
def top_k_top_p_filtering(
    ...
    Copied from Hugging Face transformers <=4.38 (removed in later versions).
    ...
    Args:
        ...
        filter_value: logits to replace the filtered ones with (default: -Inf)
        min_tokens_to_keep: min number of tokens to keep
    """
    logits = logits.clone()
